...
class FormularioComida extends Form
{
    ...
    {
        parent::__construct('comidas', array());
    }
    ...
    protected function procesaFormulario($datos)
    {
        ...
        if ((empty($_REQUEST['alimento_1'])) || (trim($_REQUEST['alimento_1']) != ''))
        {
        ...
        {
            $erroresFormulario[] = "No puede haber dos alimentos iguales. 
            La cantidad de alimentos consumidos no se tiene en cuenta";
        }
        else
        {
