...
{    
    ...
    public function registrarComida($alimento_1, $alimento_2, $alimento_3, $tipo, $nif)
    {
        ...
        $consulta_idComidas = $this->consultar($query_numComidas); // ¿me devuelve el numero de ids?
        $num_idComidas = mysqli_fetch_assoc($consulta_idComidas); // ¿se puede quitar?
        ...
        $query_i_comida = "INSERT into comida(dia, tipo, usuario) values (null,'".$tipo."','".$nif."')";
